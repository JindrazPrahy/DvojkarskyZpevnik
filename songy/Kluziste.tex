...
\sloka 
	^{C{\color{white}aaaa}}Strejček ^{Emi}kovář ^{Ami7}chytil ^{C}kleště, 
...
\refren
	Zatím ^{C}tři bílé ^{Emi}vrány ^{Ami7}pěkně za ^{C}sebou
	
	kolem ^{Fmaj7}jdou, někam ^{C}jdou, do ^{D7}rytmu se ^{G}kývaj,

	tyhle ^{C}tři bílé ^{Emi}vrány ^{Ami7}pěkně za ^{C}sebou

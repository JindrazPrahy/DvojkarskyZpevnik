...
tak de za ^{Emi}mnu a ja ^{A}všecko najdu 
...
\end{minipage}\begin{minipage}[t]{0.5\textwidth}\setlength{\parindent}{0.45cm}\vspace*{1.07cm}  % V případě varianty č.2 jde odsud text do pravé části

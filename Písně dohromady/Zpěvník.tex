...
\usepackage[top=1.5cm, bottom=0cm, left=2cm, right=2cm]{geometry}  % --> NASTAVENÍ OKRAJŮ
\usepackage{fancyhdr}
\usepackage{graphicx}
\usepackage{lmodern}
...
\input{../songy/ASkautskaHymna}\newpage
%\input{../songy/CernejPasazer}\newpage
%\input{../songy/CernobilySvet}\newpage
%\input{../songy/DoAmeriky}\newpage
%\input{../songy/DoDneADoRoka}\newpage
%\input{../songy/GodsGonnaCutYouDown}\newpage %%!!! Akordy dát nad nad slova, vyřadit opakující se akordy
%\input{../songy/Hallelujah}\newpage  %%% Pouze jednostranná verze
%\input{../songy/HeyHo}\newpage
%\input{../songy/HlidacKrav}\newpage
%\input{../songy/JeJakaJe}\newpage
%\input{../songy/Kamaradi}\newpage %není hotovo
%\input{../songy/KaravanaMraku}\newpage	
%\input{../songy/Knockin}\newpage
%\input{../songy/Kutil}\newpage
%\input{../songy/LanoCoKNebiNasPouta}
%\input{../songy/LeavingOnAJetPlane}\newpage
%\input{../songy/LemonTree}\newpage
%\input{../songy/MadeInValmez}\newpage
%\input{../songy/Milionar}\newpage
%\input{../songy/Orlice}\newpage
%\input{../songy/OstravoOstravo}\newpage
%\input{../songy/Pangajo}\newpage
%\input{../songy/PisnickaProTebe}\newpage
%\input{../songy/Podzimni}\newpage
%\input{../songy/PrevratVBananoveRep}
%\input{../songy/RadaSeMiluje}\newpage
%\input{../songy/SlaviciZMadridu}\newpage
%\input{../songy/SoundOfSilence}\newpage
%\input{../songy/Traktor}\newpage
%\input{../songy/WhatMakesYouBeautiful}\newpage
%\input{../songy/ZMyPluli}\newpage

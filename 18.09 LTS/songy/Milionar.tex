...
\begin{minipage}[t]{0.48\textwidth}\setlength{\parindent}{\pindent}  %Varianta č. 2 --> Dva sloupce
\sloka
...
\end{minipage}\begin{minipage}[t]{0.5\textwidth}\setlength{\parindent}{\pindent}\vspace*{1.07cm}  % V případě varianty č.2 jde odsud text do pravé části

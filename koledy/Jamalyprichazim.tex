\begin{song}{title=\centering Já malý přicházím \\\normalsize   \vspace*{-0.3cm}}  %% sem se napíše jméno songu a autor
\moveright 4.5cm \vbox{      %Varianta č. 1  ---> Jeden sloupec zarovnaný na střed	

\sloka 
	^{D}Já malý přicházím ^{A\,D}koledovat,
	
	co umím o Kristu ^{A7\,D}prozpěvovat.
	
	Že se ^{A}narodil ^{D}v Betlémě ^{A}v chlévě, ^{D}chci ^{A7\,D}zvěstovat.

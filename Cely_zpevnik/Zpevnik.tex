...
tak i jen pár let existující aktuální hity, na něž jsem musel z odposlechu skládat akordy a noty.
Tento zpěvník se částečně skládá
z písní minulých generací Dvojkařů ze zpěvníku 2004 od Aleše a Sumce,
z roverského zpěvníku 2012 od Krdlíka,
z \uv{Old--School} zpěvníku 2015 od Sumce a
z minulých verzí tohoto zpěvníku 2018 a 2020.

V roce 2017 se generace kluků z Pražské Dvojky, v té době pod vedením Jindry a Docenta, podívali do vlastních zdrojů a
dospěli k tomu, že dosud ještě neexistuje žádný uspokojivý zpěvník, jenž by obsahoval všechny oblíbené písničky.
Mnoho písní se tahalo po různých minulých zpěvnících a vlastních materiálench, a tak texty písní nebyly každému dostupné.
Založil jsem tedy repozitář na jeden zpěvník a po trdé práci spolu s ostatními členy v jazyku \LaTeX \, při
předtáborové LAN party vytvořili prototyp zpěvníku následně přetvořený zejména Jindrou do zpěvníku 2018.
Díky {\LaTeX}u byla tato verze automaticky formátována a přizpůsobena pro A5 kroužkovou vazbu umožňujíce vkládat
nové písně do stejného zpěvníku.
Paralelně s kluky Sluníčka vytvořila vlastní zpěvník, a tak problém nedostupnosti písní pro každého na našich společných
táborech přetrvával, dokud nevznikl jeden společný zpěvník 2020, přibližně dvojnásobně větší než zpěvník 2012.

Proč zpěvník 2020 teď nestačí? 
Protože minulý zpěvník byl tak trochu ušit horkou jehlou.
Při hraní písní jsem ve zpěvníku nalezl mnoho chyb a stále chybělo několik oblíbených písní.
Proto, tato verze zpěvníku 2022 má přidáno 15 nových a odstraněno 23 nehraných písní oproti verzi 2020.
Všiml jsem si, že mnoho kytaristů hraje jen jednoduché kvintakordy, což většinou stačí,
ale neví si rady s basovými a s rozšířenými akordy.
Zpěvník 2022 toto řeší přidáním hmatníkových diagramů akordů.
Nicméně, u některých písní diagramy akordů přímo neodpovídají jednoduchým kvintakordům v písni.
Tyto akordy slouží jako návrh k vylepšení nebo k přiblížení hry k originálu.
Navíc, písně občas mají přidané taby s notami obsahující všelijaké vyhrávky, a tak se do hraní může přidat i další nástroj
než jen kytara.
...
Směřujte je prosím na \href{https://github.com/JindrazPrahy/DvojkarskyZpevnik}{GitHub}.

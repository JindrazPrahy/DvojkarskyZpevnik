\begin{song}{title=\predtitle\centering Černej Pasažér \\\large Traband \vspace*{-0.3cm}}  %% sem se napíše jméno songu a autor
\nejvetsi

\begin{centerjustified}
\begin{varwidth}[t]{0.48\textwidth}\setlength{\parindent}{0.25cm}  %Varianta č. 2 --> Dva sloupce
...
\end{varwidth}\mezisloupci \begin{varwidth}[t]{0.48\textwidth}\setlength{\parindent}{0.45cm}  % V případě varianty č.2 jde odsud text do pravé části
\vspace*{0.47cm}

...
\sloka 
  ...
  ^{C{\color{white}\_\_\_\_\_\_}}vytetovanou na 
...
\end{varwidth}\mezisloupci \begin{varwidth}[t]{0.48\textwidth}\setlength{\parindent}{0.45cm}\vspace*{0.47cm}  % V případě varianty č.2 jde odsud text do pravé části

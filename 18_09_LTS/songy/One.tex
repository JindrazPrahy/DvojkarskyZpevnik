\begin{song}{title=\predtitle\centering One \\\large Johnny Cash  \vspace*{-1.6cm}}  %% sem se napíše jméno songu a autor
\begin{centerjustified}

\normalsize
\begin{varwidth}[t]{0.55\textwidth}\setlength{\parindent}{0.25cm} %Varianta č. 2 --> Dva sloupce
...
\end{varwidth}\mezisloupci\begin{varwidth}[t]{0.55\textwidth}\setlength{\parindent}{0.25cm}\vspace*{0.0cm}  % V případě varianty č.2 jde odsud text do pravé části
{\setlength{\parskip}{0pt}

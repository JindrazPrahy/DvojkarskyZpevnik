...
u~každé písničky akordy nad celým textem a na konci přehled použitých akordů.
Písničky v tomto zpěvníku obsažené považujeme za vhodné k~učení se hraní na
kytaru.
Připomínky uvítáme na emailu \verb|jd@mamlasinky.com|. Kód zpěvníku je k~dispozici i~na GitHubu. \\ \\
...
\phantomsection\addcontentsline{toc}{section}{Knockin' on Heaven's Door}\input{./songy/Knockin.tex}\newpage
\phantomsection\addcontentsline{toc}{section}{Ráda se miluje}\input{./songy/RadaSeMiluje.tex}\newpage
\phantomsection\addcontentsline{toc}{section}{Zabili}\input{./songy/Zabili.tex}\newpage
\phantomsection\addcontentsline{toc}{section}{Zatači}\input{./songy/Zatanci.tex}\newpage

...
\sloka 
  ^{Ami}Když se snáší noc na střechy Petěrburgu, ^{F{\color{white}\_\_}}padá ^{E}na mě ^{Ami}žal,

  zatoulaný pes nevzal si ani kůrku ^{F{\color{white}\_\_\_}}chleba, kterou ^{E{\color{white}\_\_}}jsem mu ^{Ami}dal.

\refren
  /: ^{C{\color{white}\_\_\_}}Lásku moji ^{Dmi\,\,\,}kníže ^{E}Igor si bere,
